...
using aiTherapist.Models.TokenAuth;
...
public abstract class aiTherapistWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static aiTherapistWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(aiTherapistWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<aiTherapistDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<aiTherapistDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<aiTherapistDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<aiTherapistDbContext, Task<T>> func)
    {
        T result;
